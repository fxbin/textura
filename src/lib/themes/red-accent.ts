...
export const redAccentThemes: Theme[] = [
  {
    ...
    styles: {
      ...
      p: 'margin: 10px 10px 20px; line-height: 1.75; letter-spacing: 0.04em; font-size: 14px; word-spacing: normal; text-align: left;',
      ...
      li: 'margin: 5px 0;',
      'li > p': 'margin: 0; letter-spacing: normal; word-spacing: normal; text-align: left;',
